...
<section class="panel detail">
    <div class="section-head"><h2>${classItem.CTitle}</h2><a class="btn secondary" href="/classes">목록으로</a></div>
    ...
    <div class="actions">
        <form method="post" action="/classes/${classItem.CNum}/like" class="inline-form"><button type="submit">좋아요</button></form>
        <form method="post" action="/payments/cart/${classItem.CNum}" class="inline-form"><button type="submit">장바구니 담기</button></form>
...
<section class="two-column">
    <article class="panel">
        <div class="section-head"><h2>후기</h2><a href="/reviews">전체 후기</a></div>
        <c:forEach var="review" items="${reviews}">
            <a class="list-link" href="/reviews/${review.RNum}">${review.RTitle}<em>${review.RUid}</em></a>
        </c:forEach>
    </article>
    <article class="panel">
        <div class="section-head"><h2>문의</h2><a href="/qna">전체 문의</a></div>
