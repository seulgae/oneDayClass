...
<section class="form-panel member-form-panel">
    <div class="member-form-hero">
        <h2>회원가입</h2>
        <p>가입에 필요한 항목만 먼저 정리했습니다. 상세 규칙은 각 섹션의 안내 보기에서 확인할 수 있습니다.</p>
    </div>
        ...
        <section class="form-section">
            ...
            <div class="field-grid two-column-grid">
                <label class="field-block">
                    ...
                    <input type="text" name="uId" required pattern="^[a-zA-Z0-9]{4,20}$" title="아이디는 영문과 숫자 4~20자입니다." autocomplete="username">
                </label>
                <label class="field-block">
                    <span class="field-label">이름 <span class="required-mark">*</span></span>
                    <input type="text" name="uName" required pattern="^[가-힣a-zA-Z]{2,20}$" title="이름은 한글 또는 영문 2~20자입니다." autocomplete="name">
                </label>
                <label class="field-block">
                    <span class="field-label">비밀번호 <span class="required-mark">*</span></span>
                    <input type="password" id="joinPassword" name="uPw" required pattern="^(?=.*[A-Za-z])(?=.*[0-9])(?=.*[!@#$%^&*()_+\-={}\[\]:;,.?/]).{8,20}$" title="비밀번호는 영문, 숫자, 특수문자를 포함한 8~20자입니다." autocomplete="new-password">
                </label>
                <label class="field-block">
                    <span class="field-label">비밀번호 확인 <span class="required-mark">*</span></span>
                    <input type="password" id="joinPasswordConfirm" required autocomplete="new-password">
                </label>
            </div>
        </section>
        ...
        <section class="form-section">
            ...
            <div class="field-grid two-column-grid teacher-only is-hidden" id="teacherFields" hidden>
                <label class="field-block">
                    ...
                    <input type="text" id="sName" name="sName" pattern="^[가-힣a-zA-Z0-9\s.,()_-]{2,50}$" title="강사 활동명은 한글, 영문, 숫자와 일부 기호를 포함해 2~50자까지 입력할 수 있습니다." placeholder="예: 원데이 클래스 by 민지">
                </label>
                <label class="field-block">
                    <span class="field-label">강사 SNS 주소</span>
                    <input type="url" id="sSns" name="sSns" placeholder="https://">
                </label>
            </div>
        </section>
        ...
        <section class="form-section">
            ...
            <div class="field-grid two-column-grid">
                <label class="field-block">
                    ...
                    <input type="text" name="uPhone" pattern="^01[0-9]-?\d{3,4}-?\d{4}$" title="휴대폰 번호 형식이 올바르지 않습니다." placeholder="010-1234-5678" autocomplete="tel">
                </label>
                <label class="field-block">
                    <span class="field-label">이메일</span>
                    <input type="email" name="uEmail" placeholder="name@example.com" autocomplete="email">
                </label>
            </div>
            <div class="field-block">
                <span class="field-label">주소</span>
                <div class="zip-field">
                    <input type="text" id="uZip" name="uZip" placeholder="우편번호" readonly>
                ...
                <div class="field-grid address-grid">
                    <input type="text" id="uAddr1" name="uAddr1" placeholder="기본주소" readonly>
                    <input type="text" id="uAddr2" name="uAddr2" placeholder="상세주소">
                </div>
            </div>
        </section>
