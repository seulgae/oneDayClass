    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http,
        ...
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers("/classes/new").hasRole("TEACHER")
                        .requestMatchers(HttpMethod.POST, "/classes").hasRole("TEACHER")
                        .requestMatchers("/classes/*/edit", "/classes/*/delete").hasAnyRole("TEACHER", "ADMIN")
                        .requestMatchers(HttpMethod.POST, "/classes/*/edit", "/classes/*/delete").hasAnyRole("TEACHER", "ADMIN")
                        .anyRequest().denyAll()
                )
                .formLogin(form -> form
